      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm max-w-xs">
              Transform your content into engaging social media posts, newsletters, and more with AI-powered generation.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://linkedin.com/company/swiftcopy"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
              >
              ...
              <a
                href="https://github.com/swiftcopy"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
              >
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            © 2025 SwiftCopy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
